# Computer Tablet Microsoft Surface Pro 3  
...
### id
* oomp_id: computer_tablet_microsoft_surface_pro_3
...
### other_codes
* short_code: 
* oomp_word: boot dancer sailboat
* oomp_word_emoji :boot: :dancer: :sailboat:
* md5_6_alpha: 6octe
* md5_6: ab1ce2
...
| directory | parts/computer_tablet_microsoft_surface_pro_3 |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/computer_tablet_microsoft_surface_pro_3 |  
| id | computer_tablet_microsoft_surface_pro_3 |  
| id_no_class | tablet_microsoft_surface_pro_3 |  
| id_no_color | pro3 |  
| id_no_size | pro_3 |  
| id_no_type | microsoft_surface_pro_3 |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | ab1ce28c4df94999b122419c3ff3c557 |  
| md5_10 | ab1ce28c4d |  
| md5_10_upper | AB1CE28C4D |  
| md5_5 | ab1ce |  
| md5_5_upper | AB1CE |  
| md5_6 | ab1ce2 |  
| md5_6_alpha | 6octe |  
| md5_6_alpha_upper | 6OCTE |  
| md5_6_upper | AB1CE2 |  
| name | Computer Tablet Microsoft Surface Pro 3 |  
| name_no_class | Tablet Microsoft Surface Pro 3 |  
| name_no_color | Pro3 |  
| name_no_size | Pro 3 |  
| name_no_type | Microsoft Surface Pro 3 |  
| oomp_key | oomp_computer_tablet_microsoft_surface_pro_3 |  
| oomp_word | boot dancer sailboat |  
| oomp_word_emoji | :boot: :dancer: :sailboat: |  
| oomp_word_emoji_list | [':boot:', ':dancer:', ':sailboat:'] |  
| oomp_word_list | ['boot', 'dancer', 'sailboat'] |  
| part_number |  |  
| part_number_name |  |  
| size | microsoft_surface |  
| size_length_1 | m |  
