# Hardware Standoff M3 9 mm Length Nut And Nut  
...
### id
* oomp_id: hardware_standoff_m3_9_mm_length_nut_and_nut
...
### other_codes
* short_code: so3m9nn
* oomp_word: cloud maple_leaf sleeping
* oomp_word_emoji :cloud: :maple_leaf: :sleeping:
* md5_6_alpha: 1oydi
* md5_6: 2b6506
...
| directory | parts/hardware_standoff_m3_9_mm_length_nut_and_nut |  
| github_link | https://github.com/oomlout/oomlout_oomp_part_src/tree/main/parts/hardware_standoff_m3_9_mm_length_nut_and_nut |  
| id | hardware_standoff_m3_9_mm_length_nut_and_nut |  
| id_no_class | standoff_m3_9_mm_length_nut_and_nut |  
| id_no_color | 9mmlengthnutandnut |  
| id_no_size | 9_mm_length_nut_and_nut |  
| id_no_type | m3_9_mm_length_nut_and_nut |  
| manufacturer |  |  
| manufacturer_name |  |  
| md5 | 2b65067856bf4e98e36a7a9d604562cc |  
| md5_10 | 2b65067856 |  
| md5_10_upper | 2B65067856 |  
| md5_5 | 2b650 |  
| md5_5_upper | 2B650 |  
| md5_6 | 2b6506 |  
| md5_6_alpha | 1oydi |  
| md5_6_alpha_upper | 1OYDI |  
| md5_6_upper | 2B6506 |  
| name | Hardware Standoff M3 9 mm Length Nut And Nut |  
| name_no_class | Standoff M3 9 mm Length Nut And Nut |  
| name_no_color | 9mmlengthnutandnut |  
| name_no_size | 9 mm Length Nut And Nut |  
| name_no_type | M3 9 mm Length Nut And Nut |  
| oomlout_bolt_color |  |  
| oomlout_bolt_head_type | Bolt |  
| oomlout_bolt_length | 9 mm |  
| oomlout_bolt_length_no_unit | 9 |  
| oomlout_bolt_md5_6_alpha_first_3 | 1oy |  
| oomlout_bolt_md5_6_alpha_first_3_upper | 1OY |  
| oomlout_bolt_md5_6_alpha_last_3 | di |  
| oomlout_bolt_md5_6_alpha_last_3_upper | DI |  
| oomlout_bolt_md5_6_first_3 | 2b6 |  
| oomlout_bolt_md5_6_first_3_upper | 2B6 |  
| oomlout_bolt_md5_6_last_3 | 506 |  
| oomlout_bolt_md5_6_last_3_upper | 506 |  
| oomlout_bolt_name |  M3X9 mm  (Bolt) |  
| oomlout_bolt_size | M3 |  
| oomlout_bolt_type |  |  
| oomlout_bolt_type_diagram_diagram | type_diagram.png |  
| oomlout_short_code | so3m9nn |  
| oomlout_short_code_upper | SO3M9NN |  
| oomp_key | oomp_hardware_standoff_m3_9_mm_length_nut_and_nut |  
| oomp_word | cloud maple_leaf sleeping |  
| oomp_word_emoji | :cloud: :maple_leaf: :sleeping: |  
| oomp_word_emoji_list | [':cloud:', ':maple_leaf:', ':sleeping:'] |  
| oomp_word_list | ['cloud', 'maple_leaf', 'sleeping'] |  
| part_number |  |  
| part_number_name |  |  
| size | m3 |  
| size_length_1 | m |  
